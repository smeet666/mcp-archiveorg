 ...
 *
 * The Internet Archive charges nobody and turns nobody away, which is a reason
 * to be careful rather than a licence to be fast. Serialising also means a
 * burst of tool calls cannot turn into a burst of connections.
 *
